...
CODE_INTERPRETER_GIT_REF="${CODE_INTERPRETER_GIT_REF:-170194fa8e2f5bfb396b76e35d12ce88597a7c47}"  # dev
CODE_INTERPRETER_IMAGE="${CODE_INTERPRETER_IMAGE:-librecodeinterpreter:170194f}"
